...
//    private var param2: String? = null
    private lateinit var btnSyntaxEditText: Button
...
//            param2 = it.getString(ARG_PARAM2)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        btnSyntaxEditText = view.findViewById(R.id.btnSyntaxEditText)
       ...
       val controller = Navigation.findNavController(requireActivity(), R.id.nav_host_fragment)
        ...
        btnSyntaxEditText.setOnClickListener {
//            Navigation.createNavigateOnClickListener(R.id.syntaxEditTextFragment, null)
            controller.navigate(R.id.action_homeFragment_to_syntaxEditTextFragment)
        }


        btnNetwork.setOnClickListener {
//            Navigation.createNavigateOnClickListener(R.id.networkFragment, null)
